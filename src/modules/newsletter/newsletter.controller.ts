...
export class NewsletterController {
  ...
  @ApiOperation({
    ...
    description:
      'Subscribe to the newsletter with optional preferences. If no preferences are provided, defaults to all types enabled.',
  })
  @ApiResponse({
    status: 201,
  ...
  async sendNewsletter(@GetUser('id') userId: string, @Req() request: Request) {
