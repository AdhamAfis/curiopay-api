...
export class UserPreferencesService {
  ...
  async updateUserPreferences(userId: string, updateUserPreferencesDto: UpdateUserPreferencesDto) {
    ...
    if (!preferences) {
      return this.userPreferencesRepository.create(userId, updateUserPreferencesDto);
    }
    
    return this.userPreferencesRepository.update(userId, updateUserPreferencesDto);
  }
  ...
  async toggleAiFeatures(userId: string) {
    ...
    if (!preferences) {
      return this.userPreferencesRepository.create(userId, { enableAiFeatures: true });
    }
